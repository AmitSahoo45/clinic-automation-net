...
export function PublicLayout() {
  return (
    <div className="min-h-screen px-3 py-4 md:px-6 lg:px-8 2xl:px-10">
      <div className="mx-auto grid max-w-[1780px] gap-4 lg:gap-6 xl:grid-cols-[minmax(760px,1.12fr)_minmax(700px,0.88fr)] xl:gap-8">
        ...
        <section className="flex min-h-[640px] items-center xl:min-h-[calc(100vh-2rem)]">
